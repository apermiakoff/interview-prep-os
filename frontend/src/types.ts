...
export interface VisualEvent { op: "show" | "hide" | "visit" | "compare" | "update" | "push" | "pop" | "move" | "select" | "phase" | "accept" | "reject" | "union" | "complete"; targets: string[]; value?: string | number | boolean | null; note: string }
